...
export default function Vendors({ weddingId, onAddVendor, refreshKey, onRefresh }: Props) {
    ...
    <div className="page">
      <div className="fbar">
        ...
        <div className="ml" style={{ display: 'flex', gap: 7 }}>
          ...
          <button className="btn btn-p btn-sm" onClick={onAddVendor}><i className="ti ti-plus" /> Add Vendor</button>
        </div>
      </div>
          ...
          <div className="row" key={v.id}>
            ...
            <div style={{ textAlign: 'right' }}>
              ...
              <div style={{ marginTop: 4, display: 'flex', gap: 4, justifyContent: 'flex-end' }}>
                <button className="btn btn-sm" onClick={() => v.id && deleteVendor(v.id)} style={{ color: 'var(--coral)', borderColor: 'var(--coral-l)' }}>
